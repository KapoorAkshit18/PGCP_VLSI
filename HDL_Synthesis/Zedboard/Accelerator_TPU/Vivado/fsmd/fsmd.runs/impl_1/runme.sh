...
HD_PWD='C:/Users/akshi/Downloads/nn_system_architecture/simulations_rema_modules/digital_design_verification/fsmd/fsmd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsmd_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsmd_bd_wrapper.tcl -notrace
