...
HD_PWD='C:/Users/akshi/Downloads/nn_system_architecture/simulations_rema_modules/digital_design_verification/fsmd/fsmd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsmd_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsmd_bd_wrapper.tcl
