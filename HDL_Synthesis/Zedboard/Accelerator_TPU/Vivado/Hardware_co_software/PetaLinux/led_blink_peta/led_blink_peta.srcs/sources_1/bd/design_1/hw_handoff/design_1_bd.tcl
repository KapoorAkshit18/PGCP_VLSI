...
proc create_root_design { parentCell } {
  ...
  set led_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 led_0 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_GPIO_0 [get_bd_intf_ports led_0] [get_bd_intf_pins processing_system7_0/GPIO_0]
